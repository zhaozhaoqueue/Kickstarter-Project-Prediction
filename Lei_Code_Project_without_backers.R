...
mean(pred_tree_unpruned == da_val$state)
...
1 - mean(pred_log == da_oh_val$state)
...
pred_test_knn = knn(da_oh_scaled_train[, -27], da_oh_scaled_val[, -27], da_oh_scaled_train$state, k=2)
